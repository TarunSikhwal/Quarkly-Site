...
import { Theme, Link, Text, Image, Box, Icon, Input, Button } from "@quarkly/widgets";
import { Helmet } from "react-helmet";
import { GlobalQuarklyPageStyles } from "global-page-styles";
import { Override, Menu, Section, StackItem, Stack, Formspree, SocialMedia } from "@quarkly/components";
import { MdArrowDownward, MdHelp, MdLocationOn, MdEmail, MdPhone, MdFace } from "react-icons/md";
	...
	return <Theme theme={theme}>
		...
		<Section>
			...
			>
				...
				<Image width="64px" height="64px" src="https://uploads.quarkly.io/6030bca1465b2a001e0e9779/images/wfvq-removebg-preview.png?v=2021-02-20T08:12:12.216Z" />
				<Menu
					display="flex"
					font="--base"
					font-weight="700"
